##################################################################
## This scripts creates a plot3.png file that represent household
## energy usage of Sub_metering_1, Sub_metering_2,
## Sub_metering_3 over a 2-day period in February, 2007
##
## This script:
